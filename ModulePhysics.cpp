...
#define METERS_TO_PIXELS(meters) (meters / 0.002645833)
#define PIXEL_TO_METERS(pixels) (pixels * 0.002645833)
...
bool ModulePhysics::Start()
{
	...
	// TODO 4: Create a a big static circle as "ground"
	  ...
	  body_def.position.Set(PIXEL_TO_METERS(500), PIXEL_TO_METERS(400));
	  b2Body* body = world->CreateBody(&body_def);

	  b2CircleShape shape;
	  shape.m_radius = PIXEL_TO_METERS(250);
